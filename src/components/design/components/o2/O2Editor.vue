  ...
  <DesignEditor :desc="desc">
    <Form :label-width="70">
      ...
      <FormItem label="卡券组" style="margin-bottom: 12px">
        <Select v-model="designValue.templateId" filterable clearable placeholder="选择商品组则上面卡券ID无效" @on-change="onSelectGoodsGroup">
...
export default {
  ...
  computed: {
    designGoodsGroup () {
      ...
      return group.filter(item => item.type === 'o2')
    }
  },
  created () {},
  methods: {
