  ...
  <div class="box">
    ...
    <Modal v-model="addModal" width="460">
      ...
      <Form ref="form" :model="addData" :rules="rules" :label-width="70">
        <FormItem prop="typename" label="类型名称">
          <Input v-model="addData.typename" placeholder="请输入名称"></Input>
        </FormItem>
        <FormItem prop="urlimg" label="图片地址">
          <Input  v-model="addData.urlimg" placeholder="请输入地址"></Input>
        </FormItem>
      </Form>
      <div slot="footer">
    ...
    <Modal v-model="editModal" width="460">
      ...
      <Form ref="form" :model="editData" :rules="rules" :label-width="70">
        <FormItem prop="typename" label="类型名称">
          <Input v-model="editData.typename" placeholder="请输入名称"></Input>
        </FormItem>
        <FormItem prop="urlimg" label="图片地址">
          <Input  v-model="editData.urlimg" placeholder="请输入地址"></Input>
        </FormItem>
      </Form>
      <div slot="footer">
  ...
  data () {
    return {
      ...
      rules: {
        ...
        urlimg: [{ required: true, message: '不能为空', trigger: 'blur' }]
      },
    }
  },
  created () {
