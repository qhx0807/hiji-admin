        ...
        <Row>
          ...
          <Col span="6">
            <FormItem label="每人可砍价次数"  prop="helpnum">
              <InputNumber :max="999999999" style="width:100%" :min="0" v-model="editData.helpnum"></InputNumber>
            </FormItem>
          </Col>
          <Col span="6">
            <FormItem label="即时购买">
              <i-switch size="large" :true-value="1" :false-value="0" v-model="editData.buynow">
            ...
            <FormItem label="砍价规则">
              ...
              <Row>
                <Col span="24" style="margin-bottom:8px" v-for="(item, index) in cutRules" :key="index">
                  ...
                  &nbsp;
                  <span><span v-show="editData.type == 1">最高</span>可砍价金额(元)</span>
