<template>
  <div class="box">
    <Card :bordered="false" class="mb10">
      ...
      <div class="tips">
        <h4><span style="font-size:14px;font-weight:500">新增商品拼团活动</span></h4>
        <p>新增商品拼团活动 <router-link :to="{name: 'CollageBuy'}">返回【拼团列表】</router-link></p>
      </div>
    ...
    <Card :bordered="false">
      <Form :model="addData" ref="form" :rules="ruleValidate" :label-width="80">
        <Row>
          ...
          <Col span="6">
            ...
            <FormItem label="团购价格"  prop="groupprice">
              <InputNumber :max="999999999" style="width:100%" :min="0" v-model="addData.groupprice"></InputNumber>
            </FormItem>
        ...
        <Row>
          <Col span="24">
            <FormItem label="拼团规则">
              <Input v-model="addData.rule"></Input>
            </FormItem>
          </Col>
          <Col span="24">
            <FormItem>
